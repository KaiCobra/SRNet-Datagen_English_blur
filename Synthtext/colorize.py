...
class Colorize(object):
    ...
    def color(self, text_arr, bg_arr, fg_col, bg_col, colorsRGB, colorsLAB, min_h, param):
        ...
        text_arr2 = np.zeros(text_arr.shape)
        text_arr2[np.where(text_arr>127)]=1
        text_arr2 = np.expand_dims(text_arr2,axis=-1)
        # l_out2 = l_normal.color * text_arr2 + bg_arr*(1-text_arr2)
        # image blit
